 ...
 */
public class WifiScanner2 extends BroadcastReceiver implements Runnable {
  /**
  ...
  private static WifiScanner2 instance = null;
   ...
   */
  private WifiScanner2(Context ctx) {
    this.ctx = ctx;
